...
def LT_multifactor(g, config, seed, rounds=100):
    result = []
    user_nodes = {
    ...
    for iter in range(rounds):
        model_temp = ep.ThresholdModel(g)
        ...
        model_temp.iteration_bunch(5)
        result.append(_infected_user_count(g, model_temp.status))
